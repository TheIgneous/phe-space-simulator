...
export const FACILITIES: Facility[] = [
  ...
  { id: "main-pitch-1", name: "Main Pitch 1", group: "Outdoor", capacity: 1, workableCapacity: 2, workableCapacityClassTimeOnly: true },
  { id: "main-pitch-2", name: "Main Pitch 2", group: "Outdoor", capacity: 1, workableCapacity: 2, workableCapacityClassTimeOnly: true },
  { id: "back-pitch-1", name: "Back Pitch 1", group: "Outdoor", capacity: 1, workableCapacity: 2 },
  { id: "back-pitch-2", name: "Back Pitch 2", group: "Outdoor", capacity: 1, workableCapacity: 2 },
